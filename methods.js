...
// console.log(array.find((el) => el.id === id ))
}
...
return array.filter((el) => delete el.address  )
}
...
return array.find((el) => el.id === id ? console.log(el.address.geo) : null)
}
// getUsersGeo(users,3);
...
return array.find((el) => el.id === id ? console.log(el.company): null )
}
...
//  return array.map((el) => el.id === id ? console.log(el.phone = phone && el): null)
...
changePhone(users,6,'768-76-876');